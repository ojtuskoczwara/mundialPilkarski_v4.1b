...
public class ControllerMecze {
    private ViewMecze view;
    ...
    public ControllerMecze(ViewMecze view, Mundial modelMundial, Rozgrywka modelRozgrywka, TypGrupy modelTypGrupy, Grupa modelGrupa,
